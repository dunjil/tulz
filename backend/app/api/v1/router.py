...
from app.api.v1.tools import qrcode, calculator, image, pdf, pdf_filler, excel, favicon, webpdf, json_formatter, markdown_pdf, text_diff, invoice, markdown_cv, cad #, ocr
...
router.include_router(cad.router, prefix="/tools/cad", tags=["CAD Conversion"])
