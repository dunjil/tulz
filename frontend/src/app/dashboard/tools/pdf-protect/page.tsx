...
export default function PDFProtectPage() {
  ...
  const protectMutation = useMutation({
    mutationFn: async (formData: FormData) => {
      const response = await api.post("/tools/pdf/protect", formData, {
        headers: { "Content-Type": "multipart/form-data" },
      });
      return response.data;
    },
    onSuccess: (data) => {
      setStatus("success", "PDF protected successfully!");
      setResult(data);
  ...
  const handleProtect = () => {
    ...
    setTimeout(() => setStatus("processing", "Protecting PDF..."), 500);
    protectMutation.mutate(formData);
  };
    ...
    <div className="max-w-6xl mx-auto">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold flex items-center gap-3">
              <div className="p-2 rounded-xl bg-gradient-to-br from-red-500/10 to-pink-500/10">
                <Lock className="h-7 w-7 sm:h-8 sm:w-8 text-red-500" />
              </div>
              Protect PDF
            </h1>
      ...
      <div className="grid lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Protection Options</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="pt-4">
                <Button
                  className="w-full h-12 text-base font-semibold bg-gradient-to-r from-red-500 to-pink-500"
                  onClick={handleProtect}
                  disabled={!selectedFiles.length || protectMutation.isPending}
                >
        ...
        <div className="lg:col-span-2">
          <Card className="h-full">
            <CardHeader>
              ...
              <CardDescription>
                {result ? "Your protected PDF is ready" : "Results will appear here"}
              </CardDescription>
            </CardHeader>
            <CardContent>
              {protectMutation.isPending ? (
                <div className="flex flex-col items-center justify-center py-16 text-center">
                  ...
                  <p className="mt-4 text-sm font-medium">Protecting your PDF...</p>
      ...
      <RelatedGuide guideSlug="how-to-password-protect-pdf" />
    </div>
  );
}
