...
export default function PDFToJPGPage() {
  ...
  const toJPGMutation = useMutation({
    ...
    onSuccess: (data) => {
      setStatus("success", "PDF converted to images!");
      setResult(data);
  ...
  return (
    <div className="max-w-6xl mx-auto">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold flex items-center gap-3">
              <div className="p-2 rounded-xl bg-gradient-to-br from-cyan-500/10 to-blue-500/10">
                <ImageIcon className="h-7 w-7 sm:h-8 sm:w-8 text-cyan-500" />
              </div>
              PDF to JPG
            </h1>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center gap-3 p-4 rounded-lg bg-muted/50">
                <ImageIcon className="h-5 w-5 text-cyan-500 flex-shrink-0" />
                <p className="text-sm text-muted-foreground">
                  Each page of your PDF will be converted to a separate high-quality JPG image.
                </p>
              </div>
              ...
              <div className="pt-4">
                <Button
                  className="w-full h-12 text-base font-semibold bg-gradient-to-r from-cyan-500 to-blue-500"
                  onClick={handleConvert}
                  disabled={!selectedFiles.length || toJPGMutation.isPending}
                >
        ...
        <div className="lg:col-span-2">
          <Card className="h-full">
            <CardHeader>
              ...
              <CardDescription>
                {result ? "Your images are ready" : "Results will appear here"}
              </CardDescription>
            </CardHeader>
            <CardContent>
              {toJPGMutation.isPending ? (
                <div className="flex flex-col items-center justify-center py-16 text-center">
                  ...
                  <p className="mt-4 text-sm font-medium">Converting to images...</p>
                  ...
                  <div className="p-4 rounded-lg bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/20">
                    ...
                    <div className="text-sm text-muted-foreground space-y-1">
                      {result.original_pages && (
                        <p>Converted {result.original_pages} pages to images</p>
                      )}
                      ...
                      >
                        <div className="flex items-start gap-3">
                          <div className="p-2 rounded-lg bg-cyan-500/10">
                            <File className="h-5 w-5 text-cyan-500" />
                          </div>
      ...
      <RelatedGuide guideSlug="how-to-convert-pdf-to-jpg" />
    </div>
  );
}
