...
export default function PDFToPowerPointPage() {
    ...
    const toPowerPointMutation = useMutation({
        ...
        onSuccess: (data) => {
            setStatus("success", "PDF converted to PowerPoint!");
            setResult(data);
    ...
    const handleConvert = () => {
        ...
        // Set processing status immediately after upload starts
        // The ProgressModal handles transitions between statuses
        toPowerPointMutation.mutate(formData);
        setStatus("processing", "Generating slides...");
    };
    ...
    return (
        <div className="max-w-6xl mx-auto">
                    ...
                    <div>
                        <h1 className="text-2xl sm:text-3xl font-bold flex items-center gap-3">
                            <div className="p-2 rounded-xl bg-gradient-to-br from-red-500/10 to-orange-500/10">
                                <Presentation className="h-7 w-7 sm:h-8 sm:w-8 text-red-600" />
                            </div>
                            PDF to PowerPoint
                        </h1>
                        <p className="text-muted-foreground mt-2 text-sm sm:text-base">
                            Convert PDF pages into editable PowerPoint presentations (.pptx)
                        </p>
                    </div>
                    <UsageBadge />
                </div>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            <div className="flex items-center gap-3 p-4 rounded-lg bg-muted/50">
                                <Presentation className="h-5 w-5 text-red-600 flex-shrink-0" />
                                <p className="text-sm text-muted-foreground">
                                    Each page will be converted into a separate slide. Perfect for presentations and repurposing content.
                                </p>
                            </div>
                            ...
                            <div className="pt-4">
                                <Button
                                    className="w-full h-12 text-base font-semibold bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700"
                                    onClick={handleConvert}
                                    disabled={!selectedFiles.length || toPowerPointMutation.isPending}
                                >
                                    {toPowerPointMutation.isPending ? (
                                        <>
                ...
                <div className="lg:col-span-2">
                    <Card className="h-full">
                        <CardHeader>
                            ...
                            <CardDescription>
                                {result ? "Your PowerPoint file is ready" : "Results will appear here"}
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            {toPowerPointMutation.isPending ? (
                                <div className="flex flex-col items-center justify-center py-16 text-center">
                                    ...
                                    <p className="mt-4 text-sm font-medium">Creating slides...</p>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="p-4 rounded-lg bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/20">
                                        ...
                                        <div className="text-sm text-muted-foreground space-y-1">
                                            <p>Pages converted to PPTX slides</p>
                                        </div>
                                    </div>
                                ...
                                <div className="flex flex-col items-center justify-center py-16 text-center">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Upload a PDF to convert to PowerPoint
                                    </p>
            ...
            <RelatedGuide guideSlug="how-to-convert-pdf-to-powerpoint" />
        </div>
    );
}
