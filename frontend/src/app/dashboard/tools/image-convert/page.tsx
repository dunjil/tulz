...
import { FileOutput, Download, Image as ImageIcon } from "lucide-react";
...
export default function ImageCompressPage() {
    ...
    const [convertFormat, setCompressFormat] = useState<"jpeg" | "webp">("jpeg");
    ...
    return (
        <div className="max-w-5xl mx-auto">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-2">
                            Transform images between JPG, PNG, and WebP with quality control
                        </p>
                    </div>
                    <UsageBadge />
                </div>
                            ...
                            <div className="space-y-2">
                                ...
                                >
                                    ...
                                    <SelectContent>
                                        ...
                                        <SelectItem value="webp">WebP (Best convertion)</SelectItem>
                                    </SelectContent>
                                </Select>
                            </div>
                            <Button
                        ...
                        {result && (
                            <>
                                <div className="border-t pt-4">
                                    <h4 className="font-medium mb-2">Converted Result</h4>
                                    <div className="border rounded-lg overflow-hidden bg-[linear-gradient(45deg,#f0f0f0_25%,transparent_25%),linear-gradient(-45deg,#f0f0f0_25%,transparent_25%),linear-gradient(45deg,transparent_75%,#f0f0f0_75%),linear-gradient(-45deg,transparent_75%,#f0f0f0_75%)] bg-[length:20px_20px] bg-[position:0_0,0_10px,10px_-10px,-10px_0px]">
                                        <img
            ...
            <RelatedGuide guideSlug="how-to-convert-images-to-webp" />
        </div>
    );
}
