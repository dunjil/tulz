...
import { Maximize, Download, Image as ImageIcon, Check, RefreshCw, Linkedin } from "lucide-react";
...
export default function LinkedinResizerPage() {
    ...
    const processMutation = useMutation({
        ...
        onSuccess: (data) => {
            setStatus("success", "Banner Ready!");
            setResult(data);
    ...
    const handleDownload = () => {
        ...
        // LinkedIn Banner standard size (1584x396 = 4:1)
        formData.append("resize_width", "1584");
        formData.append("resize_height", "396");
        formData.append("maintain_aspect", "true");

        setTimeout(() => setStatus("processing", "Resizing for LinkedIn..."), 500);
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-8">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold flex items-center gap-3 text-[#0077b5]">
                        <Linkedin className="h-8 w-8" />
                        LinkedIn Banner Resizer
                    </h1>
                    <p className="text-muted-foreground mt-2">
                        Look professional with a perfectly size cover photo
                    </p>
                </div>
                <UsageBadge />
            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 animate-in fade-in duration-500">
                    <div className="space-y-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Aspect ratio locked to 4:1</CardDescription>
                            </CardHeader>
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-xs text-center text-muted-foreground">
                            Check how it looks with your profile picture
                        </p>
                    </div>
                </div>
            )}
