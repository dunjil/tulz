...
const tool = getToolConfig("linkedin-banner-resizer");
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: tool?.description || "Free online productivity tools.",
    type: "website",
    url: `https://tulz.tools/tools/linkedin-banner-resizer`,
  },
  alternates: {
    canonical: `https://tulz.tools/tools/linkedin-banner-resizer`,
  },
  twitter: {
    title: tool?.title || "Tulz - Free Online Tools",
    description: tool?.description || "Free online productivity tools.",
