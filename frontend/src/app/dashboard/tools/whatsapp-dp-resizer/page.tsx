...
export default function WhatsappResizerPage() {
    ...
    const handleDownload = () => {
        ...
        // WhatsApp DP standard size
        formData.append("resize_width", "500");
        formData.append("resize_height", "500");
        formData.append("maintain_aspect", "true");

        setTimeout(() => setStatus("processing", "Cropping for WhatsApp..."), 500);
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-8">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold flex items-center gap-3 text-[#25D366]">
            ...
            {!originalImage ? (
                <Card className="border-dashed border-2">
                    <CardHeader>
                        <CardTitle className="text-center">Upload Profile Pic</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <FileDropzone
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 animate-in fade-in duration-500">
                    <div className="space-y-6">
                        <Card>
                            <CardHeader>
                                <CardTitle>Fit Your Photo</CardTitle>
                                <CardDescription>Position your face in the center</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    >
                                        {processMutation.isPending ? "Processing..." : "Download DP"}
                                    </Button>
                            ...
                            <Card className="bg-green-50 dark:bg-green-900/10 border-green-200 dark:border-green-900">
                                <CardContent className="p-4 flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div className="font-medium">DP Ready!</div>
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-xs text-center text-muted-foreground">
                            This is how people will see your profile picture
                        </p>
                    </div>
                </div>
            )}
