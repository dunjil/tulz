...
export default function PDFToExcelPage() {
    ...
    const toExcelMutation = useMutation({
        ...
        onSuccess: (data) => {
            setStatus("success", "PDF converted to Excel!");
            setResult(data);
    ...
    const handleConvert = () => {
        ...
        setStatus("processing", "Extracting tables...");
        toExcelMutation.mutate(formData);
    };
    ...
    return (
        <div className="max-w-6xl mx-auto">
                    ...
                    <div>
                        <h1 className="text-2xl sm:text-3xl font-bold flex items-center gap-3">
                            <div className="p-2 rounded-xl bg-gradient-to-br from-green-500/10 to-emerald-500/10">
                                <FileSpreadsheet className="h-7 w-7 sm:h-8 sm:w-8 text-green-600" />
                            </div>
                            PDF to Excel
                        </h1>
                        <p className="text-muted-foreground mt-2 text-sm sm:text-base">
                            Convert PDF files to editable Excel spreadsheets (.xlsx)
                        </p>
                    </div>
                    <UsageBadge />
                </div>
                        ...
                        <CardContent className="space-y-4">
                            <div className="flex items-center gap-3 p-4 rounded-lg bg-muted/50">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Our tool will attempt to extract tables and structure from your PDF into a clean spreadsheet.
                                </p>
                            </div>
                            ...
                            <div className="pt-4">
                                <Button
                                    ...
                                    disabled={!selectedFiles.length || toExcelMutation.isPending}
                                >
                ...
                <div className="lg:col-span-2">
                    <Card className="h-full">
                        <CardHeader>
                            ...
                            <CardDescription>
                                {result ? "Your Excel file is ready" : "Results will appear here"}
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            {toExcelMutation.isPending ? (
                                <div className="flex flex-col items-center justify-center py-16 text-center">
                                    ...
                                    <p className="mt-4 text-sm font-medium">Extracting data...</p>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="p-4 rounded-lg bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/20">
                                        ...
                                        <div className="text-sm text-muted-foreground space-y-1">
                                            <p>Found tables and extracted to XLSX</p>
                                        </div>
                                    </div>
            ...
            <RelatedGuide guideSlug="how-to-convert-pdf-to-excel" />
        </div>
    );
}
