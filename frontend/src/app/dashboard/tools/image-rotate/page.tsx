...
import { RotateCw, Download, Image as ImageIcon } from "lucide-react";
...
export default function ImageCompressPage() {
    ...
    const [rotateFormat, setCompressFormat] = useState<"jpeg" | "webp">("jpeg");
    ...
    const processMutation = useMutation({
        ...
        onSuccess: (data) => {
            setStatus("success", "Image rotated!");
            setResult(data);
    ...
    const handleCompress = () => {
        ...
        formData.append("output_format", rotateFormat);
        formData.append("quality", quality.toString());

        setTimeout(() => setStatus("processing", "Rotating image..."), 500);
    ...
    return (
        <div className="max-w-5xl mx-auto">
                            ...
                            <div className="space-y-2">
                                ...
                                >
                                    ...
                                    <SelectContent>
                                        ...
                                        <SelectItem value="webp">WebP (Best rotateion)</SelectItem>
                                    </SelectContent>
                                </Select>
                            </div>
                            <Button
                        ...
                        {result && (
                            <>
                                <div className="border-t pt-4">
                                    <h4 className="font-medium mb-2">Rotated Result</h4>
                                    <div className="border rounded-lg overflow-hidden bg-[linear-gradient(45deg,#f0f0f0_25%,transparent_25%),linear-gradient(-45deg,#f0f0f0_25%,transparent_25%),linear-gradient(45deg,transparent_75%,#f0f0f0_75%),linear-gradient(-45deg,transparent_75%,#f0f0f0_75%)] bg-[length:20px_20px] bg-[position:0_0,0_10px,10px_-10px,-10px_0px]">
                                        <img
            ...
            <RelatedGuide guideSlug="how-to-rotate-images-online-without-losing-quality" />
        </div>
    );
}
