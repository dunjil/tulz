...
export default function PDFUnlockPage() {
  ...
  const unlockMutation = useMutation({
    mutationFn: async (formData: FormData) => {
      const response = await api.post("/tools/pdf/unlock", formData, {
        headers: { "Content-Type": "multipart/form-data" },
      });
      return response.data;
    },
    onSuccess: (data) => {
      setStatus("success", "PDF unlocked successfully!");
      setResult(data);
  ...
  return (
    <div className="max-w-6xl mx-auto">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold flex items-center gap-3">
              <div className="p-2 rounded-xl bg-gradient-to-br from-yellow-500/10 to-orange-500/10">
                <Unlock className="h-7 w-7 sm:h-8 sm:w-8 text-yellow-500" />
              </div>
              Unlock PDF
            </h1>
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          <Card className="overflow-hidden">
            <CardHeader className="bg-gradient-to-r from-yellow-500/10 to-orange-500/10">
              ...
              <CardDescription>
                Drag and drop or click to select your password-protected PDF
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Unlock Options</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="pt-4">
                <Button
                  className="w-full h-12 text-base font-semibold bg-gradient-to-r from-yellow-500 to-orange-500"
                  onClick={handleUnlock}
                  disabled={!selectedFiles.length || unlockMutation.isPending}
                >
        ...
        <div className="lg:col-span-2">
          <Card className="h-full">
            <CardHeader>
              ...
              <CardDescription>
                {result ? "Your unlocked PDF is ready" : "Results will appear here"}
              </CardDescription>
            </CardHeader>
            <CardContent>
              {unlockMutation.isPending ? (
                <div className="flex flex-col items-center justify-center py-16 text-center">
                  ...
                  <p className="mt-4 text-sm font-medium">Unlocking your PDF...</p>
                ...
                <div className="flex flex-col items-center justify-center py-16 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Upload a protected PDF to unlock
                  </p>
      ...
      <RelatedGuide guideSlug="how-to-unlock-password-protected-pdf" />
    </div>
  );
}
