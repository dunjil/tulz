...
const tools = [
  ...
  {
    name: "DWG to PDF",
    description: "Convert AutoCAD DWG and DXF files to high-quality PDF. Preserves geometry and colors.",
    features: ["AutoCAD support", "Vector quality", "Preserve layers"],
    icon: Box,
  ...
  {
    name: "PDF to DWG",
    description: "Convert PDF vector graphics back to editable CAD / DXF format. Perfect for architecture.",
    features: ["Extract vectors", "Editable DXF", "Maintain scale"],
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-slate-950">
      ...
      <main className="flex-1">
        ...
        {/* Free Beta Banner */}
        <section className="py-3 px-1 bg-gradient-to-r from-green-500 to-emerald-600 dark:from-green-600 dark:to-emerald-700">
        ...
        {/* Tools Grid */}
        <section id="tools" className="py-8 px-4 bg-slate-50 dark:bg-slate-900">
